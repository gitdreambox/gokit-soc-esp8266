...
#define CLOUD_REQ_MCU_OTA          8
#define CLOUD_RES_MCU_OTA          9
...
#define CLOUD_RES_WIFI_OTA         18
#define CLOUD_REQ_DOWNLOAD_FW      19
...
#define GAGENT_HTTP_TIMEOUT        (20*ONE_SECOND)
#define GAGENT_MQTT_TIMEOUT        (5*ONE_SECOND)
#define GAGENT_STA_SCANTIME        (3*ONE_MINUTE)
#define GAGENT_AP_SCANTIME         (30*ONE_SECOND)
...
#define BUF_LEN 1024      /* depend on you platform ram size */
#define BUF_HEADLEN 128

#define xpg_assert(test) ((void)0) // 显示代码位置
...
#define SIG_TCP        1
#define SIG_UDP        2
#define SIG_CLOUD_HTTP 3
#define SIG_CLOUD_M2M  4
#define SIG_WEBCONFIG  5
#define SIG_WRITE_FW   6
#define SIG_LOG        7
#define SIG_BIGDATA    8

#define OTA_TYPE_WIFI_MASTER 1
#define OTA_TYPE_WIFI_SLAVE  2
#define OTA_TYPE_MCU         3
