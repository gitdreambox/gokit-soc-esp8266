...
//LOCAL struct espconn tcp_server;
//LOCAL struct espconn udp_server;
//LOCAL struct espconn udp_broadcast;
...
void Lan_CreateUDPBroadCastServer(int32 *pFd, uint16 udp_port );
